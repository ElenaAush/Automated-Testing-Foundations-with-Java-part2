package exceptions.mainTask.model;

import exceptions.mainTask.action.CalculateTheAverageScoreForTheTask;
import exceptions.mainTask.exception.LackOfFacultiesAtTheUniversityException;
